- view: restaurants_address_coord_fdw
  sql_table_name: public.restaurants_address_coord_fdw
  fields:
  ...
  - dimension: address_coord
    type: number
    sql: ${TABLE}."address.coord"

  - dimension: address_coord_idx
    type: number
    value_format_name: id
    sql: ${TABLE}."address.coord_idx"
